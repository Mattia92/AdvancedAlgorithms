...
int main(void) {
	...
	check_struct(tree->root->left, 20, TRUE, 15, TRUE, 50);
	check_struct(tree->root->left->left, 15, FALSE, 0, FALSE, 0);
	...
	check_struct(tree->root->left->right->left->right->left, 35, FALSE, 0, TRUE, 37);
	check_struct(tree->root->left->right->left->right->left->right, 37, FALSE, 0, FALSE, 0);
	...
	delete(tree, 15, TRUE);
	delete(tree, 20, TRUE);
	check_struct(tree->root, 100, TRUE, 50, TRUE, 160);
	check_struct(tree->root->left, 50, TRUE, 25, FALSE, 0);
	check_struct(tree->root->left->left, 25, TRUE, 22, TRUE, 40);
	check_struct(tree->root->left->left->left, 22, FALSE, 0, FALSE, 0);
	check_struct(tree->root->left->left->right, 40, TRUE, 35, FALSE, 0);
	check_struct(tree->root->left->left->right->left, 35, FALSE, 0, TRUE, 37);
	check_struct(tree->root->left->left->right->left->right, 37, FALSE, 0, FALSE, 0);
	check_struct(tree->root->right, 160, FALSE, 0, TRUE, 180);
	check_struct(tree->root->right->right, 180, FALSE, 0, FALSE, 0);

	// check rebalance on delete
	delete(tree, 180, TRUE);
	check_struct(tree->root, 40, TRUE, 35, TRUE, 100);
	check_struct(tree->root->left, 35, TRUE, 25, TRUE, 37);
	check_struct(tree->root->left->left, 25, TRUE, 22, FALSE, 0);
	check_struct(tree->root->left->left->left, 22, FALSE, 0, FALSE, 0);
	check_struct(tree->root->left->right, 37, FALSE, 0, FALSE, 0);
	check_struct(tree->root->right, 100, TRUE, 50, TRUE, 160);
	check_struct(tree->root->right->left, 50, FALSE, 0, FALSE, 0);
	check_struct(tree->root->right->right, 160, FALSE, 0, FALSE, 0);
