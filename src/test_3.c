...
int main(void) {
	...
	check_node(tree->root, 37, TRUE, 25, TRUE, 100);
	check_node(tree->root->left, 25, TRUE, 22, TRUE, 35);
	check_node(tree->root->left->left, 22, TRUE, 20, FALSE, 0);
	check_node(tree->root->left->left->left, 20, FALSE, 0, FALSE, 0);
	check_node(tree->root->left->right, 35, TRUE, 30, FALSE, 0);
	check_node(tree->root->left->right->left, 30, FALSE, 0, FALSE, 0);
	check_node(tree->root->right, 100, TRUE, 50, TRUE, 180);
	check_node(tree->root->right->left, 50, TRUE, 40, FALSE, 0);
	check_node(tree->root->right->left->left, 40, FALSE, 0, FALSE, 0);
	check_node(tree->root->right->right, 180, TRUE, 160, FALSE, 0);
	check_node(tree->root->right->right->left, 160, FALSE, 0, FALSE, 0);
